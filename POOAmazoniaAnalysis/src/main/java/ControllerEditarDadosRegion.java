...
public class ControllerEditarDadosRegion extends ControllerUtil {
    ...
    /**
     * Carrega os dados para o checkbox
     *
     * @throws FileNotFoundException excecao para caso nao encontre o arquivo
     * @throws ExecutionException excecao em tempo de execuao
     * @throws InterruptedException excecao por sofrer uma interrupcao
     */
    @FXML
     ...
     * @throws GeneralSecurityException excecao da security
     * @throws ExecutionException  excecao em tempo de exeucao
     * @throws InterruptedException execao caso seja interrompido executando
     */
    @FXML
    ...
    /**
     * @param actionEvent  chama a funcao p remover
     * @throws FileNotFoundException excecao de arquivo nao encontrado
     * @throws ExecutionException excecao enquanto estiver executando
     * @throws InterruptedException excecao caso sofra uma interrupcao
     */
