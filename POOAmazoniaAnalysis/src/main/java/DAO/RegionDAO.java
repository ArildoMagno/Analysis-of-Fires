...
public class RegionDAO implements InterfaceDAO {
     ...
     * @throws ExecutionException parar enquanto executa
     * @throws InterruptedException sofrer uma interrupcao
     */
     ...
     *
     * @param firebase Recebe um ojbeto do Firebase para poder conectar com o Firebase para baixar os dados
     * @return retorna uma lista com as regiones
     * @throws ExecutionException parar enquanto executa
     * @throws InterruptedException sofrer uma interrupcao
     */
     ...
     *
     * @param firebase Recebe um ojbeto do Firebase para poder conectar com o Firebase para baixar os dados
     * @return retorna uma lista com as regions
     * @throws ExecutionException para enquanto executa
     * @throws InterruptedException sofre uma interrupcao
     */
